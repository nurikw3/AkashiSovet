...
Cohesion: 0.05
Nodes (49): ApplicationTemplate, BaseModel, _normalize_submit_memo_args(), Application, ApplicationAttachment, ChatMessage, Meeting, Централизованные Pydantic-модели домена (заявки, пользователи, шаблон, заседания (+41 more)
...
Cohesion: 0.05
Nodes (45): generate_pdf_filename(), Генерирует стандартизированное имя для PDF-файла., Генерирует стандартизированное имя для PDF-файла., Генерирует стандартизированное имя для PDF-файла., Генерирует стандартизированное имя для PDF-файла., Генерирует стандартизированное имя для PDF-файла., Генерирует стандартизированное имя для PDF-файла., Генерирует стандартизированное имя для PDF-файла. (+37 more)
...
Cohesion: 0.12
Nodes (30): clear_chat_history(), delete_app(), get_app(), get_chat_history(), get_draft_id_for_user(), get_last_rework_app(), get_or_create_app(), get_pending_apps() (+22 more)
...
Cohesion: 0.17
Nodes (16): cb_back(), cb_del(), cb_del_ok(), cb_dl(), cb_page(), cb_rework_start(), cb_view(), cmd_my_apps() (+8 more)

### Community 15 - "Community 15"
Cohesion: 0.11
Nodes (13): clear_application_chat_history(), get_application_record(), get_draft_application_id_for_user(), get_status_counts(), list_user_applications(), Операции с заявкой: создание черновика, смена статуса, отправка на согласование,, Сырая строка из БД (как `db.get_app`): нужна, где важен исходный JSON вложений (, Обнуляет историю free-form / LLM по заявке. (+5 more)
...
Cohesion: 0.22
Nodes (8): broadcast_superusers_html(), notify_user_application_approved(), Отправка уведомлений пользователям через Telegram Bot API., Уведомляет автора о согласовании.     Если передан `pdf_file_id` — отправляет до, Рассылает HTML всем суперпользователям (например при ошибке генерации PDF)., is_superuser(), on_approve(), approve_app()
...
Cohesion: 0.33
Nodes (5): escape_markdown_v2(), is_delegation(), handle_block_input(), _send_confirm(), on_rework_input()
...
- **Why does `get_template()` connect `Community 31` to `Community 32`, `Community 0`, `Community 34`, `Community 3`, `Community 2`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 18`, `Community 19`, `Community 22`?**
  _High betweenness centrality (0.209) - this node is a cross-community bridge._
- **Why does `generate_pdf()` connect `Community 12` to `Community 1`, `Community 19`, `Community 24`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `invalidate_pdf_cache()` connect `Community 20` to `Community 64`, `Community 33`, `Community 34`, `Community 2`, `Community 12`, `Community 15`, `Community 24`?**
