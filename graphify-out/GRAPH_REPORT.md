...
Cohesion: 0.13
Nodes (27): delete_app(), get_app(), get_chat_history(), get_draft_id_for_user(), get_last_rework_app(), get_or_create_app(), get_pending_apps(), get_user_full_name() (+19 more)
...
Cohesion: 0.13
Nodes (13): Application, ApplicationAttachment, ChatMessage, Meeting, Централизованные Pydantic-модели домена (заявки, пользователи, шаблон, заседания, Заседание Правления: планируемая сущность из `meetings` (id — после появления та, Заседание Правления: планируемая сущность из `meetings` (id — после появления та, Элемент списка вложений: S3 (после выгрузки) или Telegram file_id (как в боте). (+5 more)

### Community 17 - "Community 17"
Cohesion: 0.15
Nodes (7): _default_help_text(), _get_hashed_password(), login(), reset_help_text(), settings_page(), template_editor_save(), _template_validation_message()
...
Cohesion: 0.13
Nodes (15): escape_markdown_v2(), is_delegation(), handle_block_input(), _handle_format(), Обычный флоу — редактируем то что написал юзер., Обычный флоу — редактируем то что написал юзер., Делегирование — генерируем текст блока из контекста., Обычный флоу — редактируем то что написал юзер. (+7 more)
...
Cohesion: 0.19
Nodes (13): _block_title(), _get_context(), _handle_delegation(), on_edit(), Делегирование — генерируем текст блока из контекста., Делегирование — генерируем текст блока из контекста., Делегирование — генерируем текст блока из контекста., Делегирование — генерируем текст блока из контекста. (+5 more)
...
Cohesion: 0.22
Nodes (10): clean(), Очистка markdown в значениях перед model_validate., Очистка markdown и склеенных нумерованных списков перед model_validate., _strip_md(), strip_submit_memo_args(), strip_text(), expand_numbered_newlines(), _expand_one_line_numbering() (+2 more)
...
Cohesion: 0.25
Nodes (8): application_detail_page(), approve_app(), _clean_attachments(), dashboard(), meeting_detail_page(), _parse_app(), reject_app(), _render_row()
...
Cohesion: 0.67
Nodes (3): clear_chat_history(), Сбрасывает free-form / LLM-историю по заявке (при /start, смене режима)., Сбрасывает free-form / LLM-историю по заявке (при /start, смене режима).
...
- **Why does `get_template()` connect `Community 36` to `Community 32`, `Community 1`, `Community 3`, `Community 6`, `Community 72`, `Community 40`, `Community 11`, `Community 45`, `Community 13`, `Community 49`, `Community 20`, `Community 54`, `Community 22`, `Community 29`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `generate_pdf()` connect `Community 13` to `Community 0`, `Community 36`, `Community 38`, `Community 14`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `ApplicationTemplate` connect `Community 33` to `Community 1`, `Community 67`, `Community 69`, `Community 73`, `Community 43`, `Community 16`, `Community 83`, `Community 54`?**
