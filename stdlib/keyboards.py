...
def rework_keyboard() -> InlineKeyboardMarkup:
    ...
    buttons.append([
        InlineKeyboardButton(text="📎 Изменить приложения", callback_data="rework_files"),
        InlineKeyboardButton(text="📤 Отправить повторно",  callback_data="rework_submit"),
    ])
...
def review_keyboard() -> InlineKeyboardMarkup:
    ...
    buttons.append([
        InlineKeyboardButton(text="📎 Изменить файлы", callback_data="review_files"),
    ])
    buttons.append([
        InlineKeyboardButton(text="🚀 Отправить заявку",  callback_data="review_submit"),
    ])
    return InlineKeyboardMarkup(inline_keyboard=buttons)
...
def confirm_rework_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[[
        InlineKeyboardButton(text="✅ Подтвердить", callback_data="rework_confirm"),
...
def restart_or_continue_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[[
        InlineKeyboardButton(text="▶️ Продолжить текущую", callback_data="continue_draft"),
        InlineKeyboardButton(text="🆕 Начать заново",       callback_data="restart_draft"),
    ]])
